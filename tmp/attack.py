                ...
                if self.best_loss:
                    with torch.no_grad():
                        ...
                        final_loss = {
                            ...
                            "ce-targeted": ce_loss_targeted(logits, self.y_target),
                            "dlr-targeted": dlr_loss_targeted(logits, y, self.y_target),
                        }.get(self.loss_type, torch.tensor(0.0))
                        better = final_loss > best_loss_val
                        best_loss_val[better] = final_loss[better]
