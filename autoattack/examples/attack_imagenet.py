...
class ImageNetAttack(Attack):
    def __init__(
        ...
        self.center_label_to_wordnet_path = "./datasets/ImageNet-1K/center_to_wordnet.json"
...
def main():
    ...
    parser.add_argument('--centre_embeddings_path', type=str,
    ...
    if args.center_label_to_wordnet_path != "./datasets/ImageNet-1K/center_to_wordnet.json":
