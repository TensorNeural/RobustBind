...
def main():
    ...
    parser.add_argument("--input_file", type=str, default="./ImageNet-1K/val_data.json", help="Path to the JSON file.")
    parser.add_argument("--output_dir", type=str, default="./ImageNet-1K", help="Directory to save output files.")
