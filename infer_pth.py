...
def direct_evaluate_adversarial(args, model, device="cuda"):
    ...
    adv_similarity = data_dict["adv_similarity"] if "adv_similarity" in data_dict else None
    ...
    adv_accuracy = sum(adv_label == predicted_label for adv_label, predicted_label in zip(adv_labels, predicted_labels)) / len(adv_labels) * 100
...
if __name__ == '__main__':
    ...
    parser.add_argument("--adv_pth_path", type=str, default='/home/user/datasets/ImageNet-1K/new_val_adv/eps0/eps0_0.pth')
    ...
    parser.add_argument("--output_dir", type=str, default='./outputs/val_data_zero_shot')
